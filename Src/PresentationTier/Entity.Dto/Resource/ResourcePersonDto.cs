//-----------------------------------------------------------------------
// <copyright file="ResourcePersonDto.cs" company="GoodToCode">
...
namespace GoodToCode.Entity.Resource
{
    ...
    /// EntityPerson
    /// </summary>
    public class ResourcePersonDto : EntityDto<ResourcePersonDto>, IFormattable, IPerson, IGenderId, IEntity
    {
        /// <summary>
