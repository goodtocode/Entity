...
%WINDIR%\system32\xcopy.exe %FullPath%\*.png %LibFolder%\%ProjectName%\*.* /s/r/y
%WINDIR%\system32\xcopy.exe %FullPath%\*.xbf %LibFolder%\%ProjectName%\*.* /s/r/y
%WINDIR%\system32\xcopy.exe %FullPath%\*.xml %LibFolder%\%ProjectName%\*.* /s/r/y
