...
AS
	...
	Begin
		...
		Begin
            ...
            Insert Into [Entity].[VentureResource] (VentureResourceKey, VentureKey, ResourceKey, ResourceTypeKey, RecordStateKey, ModifiedActivityKey, CreatedActivityKey) 
                Values (@Key, @VentureKey, @ResourceKey, NullIf(@ResourceTypeKey, '00000000-0000-0000-0000-000000000000'), '00000000-0000-0000-0000-000000000000', @ActivityContextKey, @ActivityContextKey)
