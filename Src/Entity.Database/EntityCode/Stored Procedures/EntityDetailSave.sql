...
AS
	...
	Begin
		...
		Begin
			...
			Insert Into [Entity].[EntityDetail] (EntityDetailKey, EntityKey, DetailKey, CreatedActivityKey, ModifiedActivityKey)
				Values (@Key, @EntityKey, @DetailKey, @ActivityContextKey, @ActivityContextKey)
