...
AS
	...
	Begin
		...
		Begin
            ...
            Insert Into [Entity].[VentureAppointment] (VentureAppointmentKey, VentureKey, AppointmentKey, RecordStateKey, ModifiedActivityKey, CreatedActivityKey) 
                Values (@Key, @VentureKey, @AppointmentKey, '00000000-0000-0000-0000-000000000000', @ActivityContextKey, @ActivityContextKey)
