...
AS
	...
	Begin
		...
		Begin
			...
			Insert Into [Entity].[Appointment] (AppointmentKey, AppointmentName, AppointmentDescription, SlotLocationKey, SlotResourceKey, TimeRangeKey, RecordStateKey, CreatedActivityKey, ModifiedActivityKey)
				Values (@Key, @Name, @Description, NullIf(@SlotLocationKey, '00000000-0000-0000-0000-000000000000'), NullIf(@SlotResourceKey, '00000000-0000-0000-0000-000000000000'), 
                        @TimeRangeKey, '00000000-0000-0000-0000-000000000000', @ActivityContextKey, @ActivityContextKey)
