...
AS
	...
	Begin
		...
		Begin
            ...
            Insert Into [Entity].[EntityAppointment] (EntityAppointmentKey, EntityKey, AppointmentKey, RecordStateKey, ModifiedActivityKey, CreatedActivityKey) 
                Values (@Key, @EntityKey, @AppointmentKey, '00000000-0000-0000-0000-000000000000', @ActivityContextKey, @ActivityContextKey)
