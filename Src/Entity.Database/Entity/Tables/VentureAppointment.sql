CREATE TABLE [Entity].[VentureAppointment] (
    ...
    [CreatedActivityKey]    UNIQUEIDENTIFIER         CONSTRAINT [DF_VentureAppointment_CreatedActivity] DEFAULT('00000000-0000-0000-0000-000000000000') NOT NULL,
	[ModifiedActivityKey]   UNIQUEIDENTIFIER         CONSTRAINT [DF_VentureAppointment_ModifiedActivity] DEFAULT('00000000-0000-0000-0000-000000000000') NOT NULL,
	...
	CONSTRAINT [FK_VentureAppointment_CreatedActivity] FOREIGN KEY ([CreatedActivityKey]) REFERENCES [Activity].[ActivityContext] ([ActivityContextKey]),
	CONSTRAINT [FK_VentureAppointment_ModifiedActivity] FOREIGN KEY ([ModifiedActivityKey]) REFERENCES [Activity].[ActivityContext] ([ActivityContextKey])
);
GO
