CREATE TABLE [Entity].[SlotLocation] (
    ...
    [CreatedActivityKey]	UNIQUEIDENTIFIER CONSTRAINT [DF_SlotLocation_CreatedActivity] DEFAULT('00000000-0000-0000-0000-000000000000') NOT NULL,
    [ModifiedActivityKey]	UNIQUEIDENTIFIER CONSTRAINT [DF_SlotLocation_ModifiedActivity] DEFAULT('00000000-0000-0000-0000-000000000000') NOT NULL,
	...
	CONSTRAINT [FK_SlotLocation_CreatedActivity] FOREIGN KEY ([CreatedActivityKey]) REFERENCES [Activity].[ActivityContext] ([ActivityContextKey]),
	CONSTRAINT [FK_SlotLocation_ModifiedActivity] FOREIGN KEY ([ModifiedActivityKey]) REFERENCES [Activity].[ActivityContext] ([ActivityContextKey])
);
GO
