CREATE TABLE [Entity].[Location] (
    ...
    [CreatedActivityKey]    UNIQUEIDENTIFIER        CONSTRAINT [DF_Location_CreatedActivity] DEFAULT('00000000-0000-0000-0000-000000000000') NOT NULL,    
    [ModifiedActivityKey]	UNIQUEIDENTIFIER         CONSTRAINT [DF_Location_ModifiedActivity] DEFAULT('00000000-0000-0000-0000-000000000000') NOT NULL,
    ...
    CONSTRAINT [FK_Location_CreatedActivity] FOREIGN KEY ([CreatedActivityKey]) REFERENCES [Activity].[ActivityContext] ([ActivityContextKey])
);
GO
