CREATE TABLE [Entity].[Resource] (
	...
	[CreatedActivityKey]    UNIQUEIDENTIFIER         CONSTRAINT [DF_Resource_CreatedActivity] DEFAULT('00000000-0000-0000-0000-000000000000') NOT NULL,
    [ModifiedActivityKey]   UNIQUEIDENTIFIER         CONSTRAINT [DF_Resource_ModifiedActivity] DEFAULT('00000000-0000-0000-0000-000000000000') NOT NULL,
	...
	CONSTRAINT [FK_Resource_CreatedActivity] FOREIGN KEY ([CreatedActivityKey]) REFERENCES [Activity].[ActivityContext] ([ActivityContextKey]),
	CONSTRAINT [FK_Resource_ModifiedActivity] FOREIGN KEY ([ModifiedActivityKey]) REFERENCES [Activity].[ActivityContext] ([ActivityContextKey])
);
GO
