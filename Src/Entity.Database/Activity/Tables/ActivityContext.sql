CREATE TABLE [Activity].[ActivityContext] (
	...
	[DeviceUuid]			NVARCHAR (250)   CONSTRAINT [DF_ActivityContext_DeviceUuid] DEFAULT ('') NOT NULL,	
	[ApplicationUuid]		NVARCHAR (250)   CONSTRAINT [DF_ActivityContext_ApplicationUuid] DEFAULT ('') NOT NULL,	    
...
GO
CREATE UNIQUE NonCLUSTERED INDEX [IX_ActivityContext_Key] ON [Activity].[ActivityContext] ([ActivityContextKey] Asc)
GO