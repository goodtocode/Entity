...
AS
	...
	Begin
		...
		Begin
			...
			Insert Into [Entity].[Venture] (VentureKey, VentureGroupKey, VentureTypeKey, VentureName, VentureDescription, VentureSlogan, RecordStateKey, CreatedActivityKey, ModifiedActivityKey)
				Values (@Key, @VentureGroupKey, @VentureTypeKey, @Name, @Description, @Slogan, '00000000-0000-0000-0000-000000000000', @ActivityContextKey, @ActivityContextKey)
