...
AS
	...
	Begin
		...
		Begin
			...
			Insert Into [Entity].[VentureDetail] (VentureDetailKey, VentureKey, DetailKey, CreatedActivityKey, ModifiedActivityKey)
				Values (@Key, @VentureKey, @DetailKey, @ActivityContextKey, @ActivityContextKey)
