...
AS
	...
	-- Validate Data
	If  (@LocationKey <> '00000000-0000-0000-0000-000000000000' AND @ActivityContextKey <> '00000000-0000-0000-0000-000000000000')
	Begin
		...
		Begin
            ...
            Insert Into [Entity].[LocationTimeRecurring] (LocationTimeRecurringKey, LocationKey, TimeRecurringKey, TimeTypeKey, RecordStateKey, ModifiedActivityKey, CreatedActivityKey) 
                Values (@Key, @LocationKey, @TimeRecurringKey, NullIf(@TimeTypeKey, '00000000-0000-0000-0000-000000000000'), '00000000-0000-0000-0000-000000000000', @ActivityContextKey, @ActivityContextKey)
