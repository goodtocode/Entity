...
AS
	...
	Begin
	    ...
	    Begin
            ...
            Insert Into [Entity].[TimeRecurring] (TimeRecurringKey, BeginDay, EndDay, BeginTime, EndTime, TimeCycleKey, CreatedActivityKey) 
                Values (@TimeRecurringKey, @BeginDay, @EndDay, @BeginTime, @EndTime, @TimeCycleKey, @ActivityContextKey)
		...
		Begin
            ...
            Insert Into [Entity].[Slot] (SlotKey, SlotName, SlotDescription, RecordStateKey, ModifiedActivityKey, CreatedActivityKey) 
                Values (@SlotKey, @SlotName, @SlotDescription, '00000000-0000-0000-0000-000000000000', @ActivityContextKey, @ActivityContextKey)            
		End
		Else
		Begin
            -- Update Slot
		...
		Begin
            ...
            Insert Into [Entity].[SlotTimeRecurring] (SlotTimeRecurringKey, SlotKey, TimeRecurringKey, TimeTypeKey, RecordStateKey, ModifiedActivityKey, CreatedActivityKey) 
                Values (@Key, @SlotKey, @TimeRecurringKey, NullIf(@TimeTypeKey, '00000000-0000-0000-0000-000000000000'), '00000000-0000-0000-0000-000000000000', @ActivityContextKey, @ActivityContextKey)
