...
AS
	...
	Begin
		...
		Begin
			...
			Insert Into [Entity].[EventOption] (EventOptionKey, EventKey, OptionKey, CreatedActivityKey, ModifiedActivityKey)
				Values (@Key, @EventKey, @OptionKey, @ActivityContextKey, @ActivityContextKey)
