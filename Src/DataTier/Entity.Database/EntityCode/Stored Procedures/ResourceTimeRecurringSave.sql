	...
	Begin
		...
		Begin
            ...
            Insert Into [Entity].[Resource] (ResourceKey, ResourceName, ResourceDescription, RecordStateKey, ModifiedActivityKey, CreatedActivityKey) 
                Values (@Key, @ResourceName, @ResourceDescription, '00000000-0000-0000-0000-000000000000', @ActivityContextKey, @ActivityContextKey)            
		End
		Else
		Begin
            -- Update Resource         
		...
		Begin
            ...
            Insert Into [Entity].[ResourceTimeRecurring] (ResourceTimeRecurringKey, ResourceKey, TimeRecurringKey, TimeTypeKey, RecordStateKey, ModifiedActivityKey, CreatedActivityKey) 
                Values (@Key, @ResourceKey, @TimeRecurringKey, NullIf(@TimeTypeKey, '00000000-0000-0000-0000-000000000000'), '00000000-0000-0000-0000-000000000000', @ActivityContextKey, @ActivityContextKey)
