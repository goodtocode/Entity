...
AS
	...
	Begin
		...
		Begin
			...
			Insert Into [Entity].[EventEntityOption] (EventEntityOptionKey, EventKey, EntityKey, OptionKey, CreatedActivityKey, ModifiedActivityKey)
				Values (@Key, @EventKey, @EntityKey, @OptionKey, @ActivityContextKey, @ActivityContextKey)
