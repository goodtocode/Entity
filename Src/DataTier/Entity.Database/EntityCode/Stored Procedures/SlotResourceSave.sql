...
AS
	...
	Begin
		...
		Begin
            ...
            Insert Into [Entity].[SlotResource] (SlotResourceKey, SlotKey, ResourceKey, ResourceTypeKey, RecordStateKey, ModifiedActivityKey, CreatedActivityKey) 
                Values (@Key, @SlotKey, @ResourceKey, NullIf(@ResourceTypeKey, '00000000-0000-0000-0000-000000000000'), '00000000-0000-0000-0000-000000000000', @ActivityContextKey, @ActivityContextKey)
