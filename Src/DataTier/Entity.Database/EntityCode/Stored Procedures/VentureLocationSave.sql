...
AS
	...
	Begin
		...
		Begin
            ...
            Insert Into [Entity].[VentureLocation] (VentureLocationKey, VentureKey, LocationKey, LocationTypeKey, RecordStateKey, ModifiedActivityKey, CreatedActivityKey) 
                Values (@Key, @VentureKey, @LocationKey, NullIf(@LocationTypeKey, '00000000-0000-0000-0000-000000000000'), '00000000-0000-0000-0000-000000000000', @ActivityContextKey, @ActivityContextKey)
