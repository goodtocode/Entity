	...
	Begin
		...
		Begin
            ...
            Insert Into [Entity].[Slot] (SlotKey, SlotName, SlotDescription, RecordStateKey, ModifiedActivityKey, CreatedActivityKey) 
                Values (@Key, @SlotName, @SlotDescription, '00000000-0000-0000-0000-000000000000', @ActivityContextKey, @ActivityContextKey)            
		End
		Else
		Begin
            -- Update Slot         
		...
		Begin
            ...
            Insert Into [Entity].[SlotTimeRange] (SlotTimeRangeKey, SlotKey, TimeRangeKey, TimeTypeKey, RecordStateKey, ModifiedActivityKey, CreatedActivityKey) 
                Values (@Key, @SlotKey, @TimeRangeKey, NullIf(@TimeTypeKey, '00000000-0000-0000-0000-000000000000'), '00000000-0000-0000-0000-000000000000', @ActivityContextKey, @ActivityContextKey)
