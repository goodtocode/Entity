CREATE TABLE [Entity].[LocationArea] (
    ...
    [CreatedActivityKey]    UNIQUEIDENTIFIER         CONSTRAINT [DF_LocationArea_CreatedActivity] DEFAULT('00000000-0000-0000-0000-000000000000') NOT NULL,
    [ModifiedActivityKey]   UNIQUEIDENTIFIER         CONSTRAINT [DF_LocationArea_ModifiedActivity] DEFAULT('00000000-0000-0000-0000-000000000000') NOT NULL,
	...
	CONSTRAINT [FK_LocationArea_CreatedActivity] FOREIGN KEY ([CreatedActivityKey]) REFERENCES [Activity].[ActivityContext] ([ActivityContextKey]),
	CONSTRAINT [FK_LocationArea_ModifiedActivity] FOREIGN KEY ([ModifiedActivityKey]) REFERENCES [Activity].[ActivityContext] ([ActivityContextKey])
);
GO
