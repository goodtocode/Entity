//-----------------------------------------------------------------------
// <copyright file="ResourcePerson.cs" company="Genesys Source">
...
namespace Genesys.Entity.Resource
{
    ...
    public class ResourcePerson : ActiveRecordEntity<ResourcePerson>, IFormattable, IPerson, IGenderCode, IEntity
    {
        /// <summary>
