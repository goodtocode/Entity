//-----------------------------------------------------------------------
// <copyright file="SlotResourceModel.cs" company="Genesys Source">
...
namespace Genesys.Entity.Schedule
{
    ...
    /// Events
    /// </summary>
    public class SlotResourceModel : EntityModel<SlotResourceModel>, ISlotResource
    {
        /// <summary>
        /// Rules used by the validator for Data Validation and Business Validation
        /// </summary>
        public override IList<IValidationRule<SlotResourceModel>> Rules()
        {
            return new List<IValidationRule<SlotResourceModel>>()
            {
                new ValidationRule<SlotResourceModel>(x => x.SlotName.Length > 0, "SlotName is required"),
                new ValidationRule<SlotResourceModel>(x => x.ResourceName.Length > 0, "ResourceName is required")
            };
        }
