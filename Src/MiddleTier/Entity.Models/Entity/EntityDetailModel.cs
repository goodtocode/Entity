//-----------------------------------------------------------------------
// <copyright file="EntityDetailModel.cs" company="Genesys Source">
...
namespace Genesys.Entity
{
    ...
    /// </summary>
    /// <remarks></remarks>
    public class EntityDetailModel : EntityModel<EntityDetailModel>, IEntityDetail
    {
        /// <summary>
        /// EntityId
        /// </summary>
