//-----------------------------------------------------------------------
// <copyright file="LocationTimeRecurringModel.cs" company="Genesys Source">
...
namespace Genesys.Entity.Location
{
    ...
    /// Events
    /// </summary>
    public class LocationTimeRecurringModel : EntityModel<LocationTimeRecurringModel>, ILocationTimeRecurring
    {
        /// <summary>
        /// Rules used by the validator for Data Validation and Business Validation
        /// </summary>
        public override IList<IValidationRule<LocationTimeRecurringModel>> Rules()
        {
            return new List<IValidationRule<LocationTimeRecurringModel>>()
            {
                new ValidationRule<LocationTimeRecurringModel>(x => x.LocationName.Length > 0, "LocationName is required")
            };
        }
        ...
        /// Constructor
        /// </summary>
        public LocationTimeRecurringModel() : base() { }
