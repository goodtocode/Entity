...
namespace GoodToCode.Entity.Activity
{
    ...
    /// </summary>    
    public class ActivitySessionflowModel : EntityModel<ActivitySessionflowModel>, IActivitySessionflow
    {
        /// <summary>
        ...
        /// </summary>
        public override IList<IValidationRule<ActivitySessionflowModel>> Rules()
        {
            return new List<IValidationRule<ActivitySessionflowModel>>()
            {
                new ValidationRule<ActivitySessionflowModel>(x => x.ApplicationKey != Defaults.Guid, "ApplicationKey is required and cannot be emtpy (00000000-0000-0000-0000-000000000000)"),
                new ValidationRule<ActivitySessionflowModel>(x => x.EntityKey != Defaults.Guid, "EntityKey is required and cannot be emtpy (00000000-0000-0000-0000-000000000000)"),
                new ValidationRule<ActivitySessionflowModel>(x => x.FlowKey != Defaults.Guid, "FlowKey is required and cannot be emtpy (00000000-0000-0000-0000-000000000000)")
            };
        }
        ...
        /// Constructor
        /// </summary>
        public ActivitySessionflowModel() : base() { }
