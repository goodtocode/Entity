//-----------------------------------------------------------------------
// <copyright file="ApplicationSettingModel.cs" company="Genesys Source">
...
namespace Genesys.Entity.Application
{
    ...
    /// </summary>    
    public class ApplicationSettingModel : EntityModel<ApplicationSettingModel>, IApplicationSetting
	{
        /// <summary>
        /// ApplicationId
        /// </summary>
