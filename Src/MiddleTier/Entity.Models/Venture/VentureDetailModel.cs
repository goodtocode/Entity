//-----------------------------------------------------------------------
// <copyright file="VentureDetailModel.cs" company="Genesys Source">
...
namespace Genesys.Entity.Venture
{
    ...
    /// </summary>
    /// <remarks></remarks>
    public class VentureDetailModel : EntityModel<VentureDetailModel>, IVentureDetail
    {
        /// <summary>
        /// VentureId
        /// </summary>
        ...
        /// </summary>
        /// <remarks></remarks>
        public VentureDetailModel() : base() { }
    }
}
